  ...
  return (
    <div className="home-container">
      ...
      <div className="home-options">
        <Link to="/client-dashboard" className="home-option">Client Dashboard</Link>
        <Link to="/staff-dashboard" className="home-option">Staff Dashboard</Link>
        <Link to="/transfer" className="home-option">Transfer Funds</Link>
        <Link to="/apply-loan" className="home-option">Apply for Loan</Link>
        <Link to="/transactions" className="home-option">Transaction History</Link>
